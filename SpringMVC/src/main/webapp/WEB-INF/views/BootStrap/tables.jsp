    ...
    <div class="main-wrapper">
      ...
      <main>
        <div class="row pl-5 pr-5 pt-5 pb-5 no-gutters">
          ...
          <div class="col-md-12">
            <h2>Tables</h2>
            <a href="#!">Home</a> / <strong>Tables</strong>
          </div>
              ...
              <section class="widget shadow-01 mb-4" id="widget-03">
                <div class="widget-block">
                  ...
                  <header>
                    ...
                    <p class="text-muted">
                      Similar to default and inverse tables, use one of two modifier classes to make <code>&lt;thead&gt;</code>s appear light or dark gray.
                    </p>
                  </header>
                  <div class="widget-content py-3">
                    <table class="table">
