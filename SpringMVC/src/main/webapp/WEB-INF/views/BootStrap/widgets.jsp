    ...
    <div class="main-wrapper">
      ...
      <main>
        ...
        <div class="row px-5 pt-5 pb-0 no-gutters">
          <div class="col-lg-12">
            <h2>Widgets</h2>
            <a href="#!">Home</a> / <strong>UI Elements</strong>
          </div>
        </div>
        <!-- /Breadcrumbs -->
        ...
        <div class="content-wrapper container-fluid px-5 mt-5 mb-4 trans-03-in-out">
          ...
          <h3 class="fw-200 pb-3">Small widgets</h3>

          <div class="row">

            <div class="col-lg-4">
              <section class="widget small shadow-01" id="widget-01">
                ...
                <div class="widget-block">
                  ...
                  <div class="widget-content pt-1">
                    <div>
                      <p class="h1">$23.654 <span>bn</span></p>
            ...
            <div class="col-lg-4">
              <section class="widget widget-dark bg-danger small shadow-01" id="widget-02">
            ...
            <div class="col-lg-4">
              <section class="widget widget-dark bg-dark small shadow-01" id="widget-03">
          ...
          <h3 class="fw-200 pb-3 pt-3">General widgets</h3>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-04">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Plain Widget</h3>
                    <p class="text-muted">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit,
            ...
            <div class="col-lg-6">
              <section class="widget widget-dark bg-dark shadow-01" id="widget-05">
                <div class="widget-block">

                  <header>
                    <h3 class="widget-title">Inverted Widget</h3>
                    <p class="text-muted">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                      sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    </p>
            ...
            <div class="col-lg-3">
              <section class="widget widget-dark bg-success shadow-01" id="widget-06">
                <div class="widget-block">

                  <header>
                    <h3 class="widget-title">Green Widget</h3>
                    <p class="text-muted">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit
                    </p>
                  </header>
            ...
            <div class="col-lg-3">
              <section class="widget widget-dark bg-danger shadow-01" id="widget-07">
                <div class="widget-block">

                  <header>
                    <h3 class="widget-title">Red Widget</h3>
                    <p class="text-muted">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit
                    </p>
                  </header>
            ...
            <div class="col-lg-3">
              <section class="widget bg-warning shadow-01" id="widget-08">
                <div class="widget-block">

                  <header>
                    <h3 class="widget-title">Yellow Widget</h3>
                    <p class="text-muted">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit
                    </p>
                  </header>
            ...
            <div class="col-lg-3">
              <section class="widget widget-dark bg-secondary shadow-01" id="widget-09">
                <div class="widget-block">

                  <header>
                    <h3 class="widget-title">Grey Widget</h3>
                    <p class="text-muted">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit
                    </p>
                  </header>
          ...
          <h3 class="fw-200 pb-3 pt-3">Shadows</h3>

          <div class="row">

            <div class="col-lg-3">
              <section class="widget" id="widget-10">
                <div class="widget-block">

                  <header>
                    <h3 class="widget-title">No Shadow</h3>
                    <p class="text-muted">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit
                    </p>
                  </header>
            ...
            <div class="col-lg-3">
              <section class="widget shadow-01" id="widget-11_2">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Shadow 01</h3>
                    <p class="text-muted">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit
                    </p>
                  </header>
            ...
            <div class="col-lg-3">
              <section class="widget shadow-02" id="widget-12">
                <div class="widget-block">

                  <header>
                    <h3 class="widget-title">Shadow 02</h3>
                    <p class="text-muted">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit
                    </p>
                  </header>
            ...
            <div class="col-lg-3">
              <section class="widget shadow-03" id="widget-13">
                <div class="widget-block">

                  <header>
                    <h3 class="widget-title">Shadow 03</h3>
                    <p class="text-muted">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit
                    </p>
                  </header>
          ...
          <h3 class="fw-200 pb-3 pt-3">Color Accents</h3>

          <div class="row">

            <div class="col-lg-3">
              <section class="widget headerline-danger shadow-01" id="widget-14">
                <div class="widget-block">
            ...
            <div class="col-lg-3">
              <section class="widget headerline-success shadow-01" id="widget-15">
                <div class="widget-block">
            ...
            <div class="col-lg-3">
              <section class="widget headerline-primary shadow-01" id="widget-16">
                <div class="widget-block">
            ...
            <div class="col-lg-3">
              <section class="widget headerline-dark shadow-01" id="widget-17">
                <div class="widget-block">
          ...
          <h3 class="fw-200 pb-3 pt-3">Outlines</h3>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <section class="widget border-2 border-danger" id="widget-19">
                <div class="widget-block">
            ...
            <div class="col-lg-6">
              <section class="widget border-3 border-success" id="widget-20">
                <div class="widget-block">
            ...
            <div class="col-lg-6">
              <section class="widget border-4 border-primary" id="widget-21">
                <div class="widget-block">
