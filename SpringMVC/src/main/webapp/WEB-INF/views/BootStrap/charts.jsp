    ...
    <div class="main-wrapper">
      ...
      <main>
        <div class="row pl-5 pr-5 pt-5 pb-5 no-gutters">
          ...
          <div class="col-md-12">
            <h2>Charts</h2>
            <a href="#!">Home</a> / <strong>Charts</strong>
          </div>
        ...
        <div class="content-wrapper container-fluid px-5 mb-4 trans-03-in-out">
          ...
          <div class="row">
            ...
            <div class="col-xl-6">
              <section class="widget shadow-01 mb-5" id="widget-02">
                <div class="widget-block">
                        ...
                        new Chart('chart-bar', {
                          ...
                          data: {
                            ...
                            datasets: [{
                              ...
                              data: [12, 82, 45, 77, 33, 54, 91, 12, 22, 66, 43, 21]
                            }]
                          },
                          options: {
                            maintainAspectRatio: false,
            ...
            <div class="col-xl-6">
              <section class="widget shadow-01 mb-5" id="widget-03">
                <div class="widget-block">
                        ...
                        new Chart('chart-bar-horizontal', {
                          ...
                          data: {
                            ...
                            datasets: [{
                              ...
                              data: [22, 102, 145, 87, 44, 154, 95, 82, 42, 106, 143, 41]
                            }, {
                              backgroundColor: '#71C7C1',
                              data: [52, 192, 155, 97, 133, 254, 122, 112, 52, 116, 153, 91]
                            }]
                          },
                          options: {
                            maintainAspectRatio: false,
            ...
            <div class="col-xl-4 col-md-12">
              <section class="widget shadow-01" id="widget-04">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Doughnut chart</h3>
                    <p class="text-muted">
            ...
            <div class="col-xl-4 col-md-12">
              <section class="widget shadow-01" id="widget-06">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Radar chart</h3>
                    <p class="text-muted">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                      eiusmod tempor incididunt ut labore et dolore
                    </p>
