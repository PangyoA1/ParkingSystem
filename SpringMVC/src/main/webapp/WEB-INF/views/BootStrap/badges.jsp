    ...
    <div class="main-wrapper">
      ...
      <main>
        ...
        <div class="row px-5 pt-5 pb-0 no-gutters">
          <div class="col-lg-12">
            <h2>Badges</h2>
            <a href="#!">Home</a> / UI Elements / <strong>Badges</strong>
          </div>
        </div>
        <!-- /Breadcrumbs -->
        ...
        <div class="content-wrapper container-fluid px-5 mt-5 mb-4 trans-03-in-out">
          ...
          <h3 class="fw-200 pb-3 pt-3">Basic usage</h3>
            ...
            <div class="col-lg-12">
              <section class="widget shadow-01" id="widget-01">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Example</h3>
                    <p>Badges scale to match the size of the immediate parent element by using relative font sizing and <code
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-03">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Contextual variations</h3>
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-04">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Pill badges</h3>
                    <p>Use the <code class="highlighter-rouge">.badge-pill</code> modifier class to make badges more rounded (with a larger <code
                        class="highlighter-rouge">border-radius</code> and additional horizontal <code class="highlighter-rouge">padding</code>). Useful if you
                      miss the badges from v3.</p>
                  </header>
              ...
              <section class="widget shadow-01" id="widget-05">
                <div class="widget-block">
                  ...
                  <header>
                    ...
                    <p>Using the contextual <code class="highlighter-rouge">.badge-*</code> classes on an <code class="highlighter-rouge">&lt;a&gt;</code>
                      element quickly provide <em>actionable</em> badges with hover and focus states.</p>
                  </header>
