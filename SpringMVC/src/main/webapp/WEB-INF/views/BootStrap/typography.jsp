    ...
    <div class="main-wrapper">
      ...
      <main>
        ...
        <div class="row px-5 pt-5 pb-0 no-gutters">
          <div class="col-lg-12">
            <h2>Typography</h2>
            <a href="#!">Home</a> / UI Elements / <strong>Typography</strong>
          </div>
        </div>
        <!-- /Breadcrumbs -->
        ...
        <div class="content-wrapper container-fluid px-5 mt-5 mb-4 trans-03-in-out">
          ...
          <h3 class="fw-200 pb-3 pt-3">Headings</h3>
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-01">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">H Headings</h3>
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-02">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Headings via classes</h3>
                ...
                <div class="col-lg-12">
                  <section class="widget shadow-01" id="widget-04">
                    <div class="widget-block">
                      ...
                      <header>
                        <h3 class="widget-title">Customizing headings</h3>
          ...
          <h3 class="fw-200 pb-3 pt-3">Text</h3>
            ...
            <div class="col-lg-3">
              <section class="widget shadow-01" id="widget-07">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Abbreviations</h3>
                    <p>Stylized implementation of HTML’s <code class="highlighter-rouge">&lt;abbr&gt;</code> element for abbreviations and acronyms to show the
                      expanded version on hover. Abbreviations have a default underline and gain a help cursor to provide additional context on hover and to
          ...
          <h3 class="fw-200 pb-3 pt-3">Blockquotes</h3>
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-08">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Simple Blockquote</h3>
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-09">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Naming a source</h3>
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-10">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Central alignment</h3>
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-11_2">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Right Alignment</h3>
                    <p>Use text utilities as needed to change the alignment of your blockquote.</p>
                  </header>
          ...
          <h3 class="fw-200 pb-3 pt-3">Lists</h3>
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-12">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Unstyled</h3>
                    <p>Remove the default <code class="highlighter-rouge">list-style</code> and left margin on list items (immediate children only). <strong>This
                      only applies to immediate children list items</strong>, meaning you will need to add the class for any nested lists as well.</p>
                  </header>
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-13">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Description list alignment</h3>
            ...
            <div class="col-lg-12">
              <section class="widget shadow-01" id="widget-14">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Inline</h3>
