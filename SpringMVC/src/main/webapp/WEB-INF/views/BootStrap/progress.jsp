    ...
    <div class="main-wrapper">
      ...
      <main>
        ...
        <div class="row px-5 pt-5 pb-0 no-gutters">
          <div class="col-lg-12">
            <h2>Progress</h2>
            <a href="#!">Home</a> / UI Elements / <strong>Progress</strong>
          </div>
        </div>
        <!-- /Breadcrumbs -->
            ...
            <div class="col-lg-12">
              <section class="widget shadow-01" id="widget-01">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Simple Progress</h3>
                    <p>Progress components are built with two HTML elements, some CSS to set the width, and a few attributes. We don’t use <a
                        ...
                        class="highlighter-rouge">&lt;progress&gt;</code> element</a>, ensuring you can stack progress bars, animate them, and place text labels
                      over them.</p>
                  </header>
              ...
              <section class="widget shadow-01" id="widget-03">
                <div class="widget-block">
                  ...
                  <header>
                    ...
                    <p>We only set a <code class="highlighter-rouge">height</code> value on the <code class="highlighter-rouge">.progress</code>, so if you
                      change that value the inner <code class="highlighter-rouge">.progress-bar</code> will automatically resize accordingly.</p>
                  </header>
                    ...
                    <div class="col-lg-12 widget-content py-2">
                      <div class="bd-example">
                        ...
                        <div class="progress" style="height: 20px;">
                          <div class="progress-bar" role="progressbar" style="width: 25%; height: 20px;" aria-valuenow="25" aria-valuemin="0"
              ...
              <section class="widget shadow-01" id="widget-06">
                <div class="widget-block">
                  ...
                  <header>
                    ...
                    <p>Add <code class="highlighter-rouge">.progress-bar-striped</code> to any <code class="highlighter-rouge">.progress-bar</code> to apply a
              ...
              <section class="widget shadow-01" id="widget-07">
                <div class="widget-block">
                  ...
                  <header>
                    ...
                    <p>The striped gradient can also be animated. Add <code class="highlighter-rouge">.progress-bar-animated</code> to <code
                        class="highlighter-rouge">.progress-bar</code> to animate the stripes right to left via CSS3 animations.</p>
                  </header>
