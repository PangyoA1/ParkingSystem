    ...
    <div class="main-wrapper">
      ...
      <main>
        <div class="row pl-5 pr-5 pt-5 pb-5 no-gutters">
          ...
          <div class="col-md-12">
            <h2>Forms</h2>
            <a href="#!">Home</a> / <strong>Forms</strong>
          </div>
        ...
        <div class="content-wrapper container-fluid px-5 mb-4 trans-03-in-out">
          ...
          <div class="row">
              ...
              <section class="widget shadow-01 mb-4" id="widget-01">
                <div class="widget-block">
                  ...
                  <header>
                    <h3>Form controls</h3>
                    <p class="text-muted">
                      Textual form controls—like <code>&lt;input&gt;</code>s, <code>&lt;select&gt;</code>s, and <code>&lt;textarea&gt;</code>s—are styled with
            ...
            <div class="col-lg-6 mb-3">
              <section class="widget shadow-01 mb-4" id="widget-02">
                <div class="widget-block">
            ...
            <div class="col-lg-6 mb-3">
              <section class="widget shadow-01 mb-4" id="widget-03">
                <div class="widget-block">
            ...
            <div class="col-lg-6 mb-3">
              <section class="widget shadow-01 mb-4" id="widget-04">
                <div class="widget-block">

                  <header>
                    <h3>Checkboxes and radios</h3>
                    <p class="text-muted">
                      Default checkboxes and radios are improved upon with the help of <code>.form-check</code>, a single class for both input types that
            ...
            <div class="col-lg-4 mb-3">
              <section class="widget shadow-01 mb-4" id="widget-05">
                <div class="widget-block">
            ...
            <div class="col-lg-4 mb-3">
              <section class="widget shadow-01 mb-4" id="widget-07">
                <div class="widget-block">

                  <header>
                    <h3>Form row</h3>
                    <p class="text-muted">
                      You may also swap <code>.row</code> for <code>.form-row</code>, a variation of our standard grid row that overrides the default column
            ...
            <div class="col-lg-6 mb-3">
              <section class="widget shadow-01 mb-4" id="widget-09">
                <div class="widget-block">
                    ...
                    <div class="container">
                      <form>
                        ...
                        <fieldset class="form-group">
                          <div class="row">
                            <label class="col-form-legend col-sm-2">Radios</label>
                            <div class="col-sm-10">
                              <div class="form-check">
                                <label class="form-check-label">
            ...
            <div class="col-lg-6 mb-3">
              <section class="widget shadow-01 mb-4" id="widget-10">
                <div class="widget-block">
            ...
            <div class="col-lg-6 mb-3">
              <section class="widget shadow-01 mb-4" id="widget-11_2">
                <div class="widget-block">

                  <header>
                    <h3>Column sizing</h3>
                    <p class="text-muted">
                      As shown in the previous examples, our grid system allows you to place any number of <code>.cols</code> within a <code>.row</code> or
                      <code>.form-row</code>.
                    </p>
                  </header>
                  <div class="widget-content py-3">
            ...
            <div class="col-lg-6 mb-3">
              <section class="widget shadow-01 mb-4" id="widget-12">
                <div class="widget-block">

                  <header>
                    <h3>Auto-sizing</h3>
                    <p class="text-muted">
                      The example below uses a flexbox utility to vertically center the contents and changes <code>.col</code> to <code>.col-auto</code> so that
