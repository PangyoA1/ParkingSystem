    ...
    <div class="main-wrapper">
      ...
      <main>
        ...
        <div class="row px-5 pt-5 pb-0 no-gutters">
          <div class="col-lg-12">
            <h2>Navs</h2>
            <a href="#!">Home</a> / UI Elements / <strong>Navs</strong>
          </div>
        </div>
        <!-- /Breadcrumbs -->
        ...
        <div class="content-wrapper container-fluid px-5 mt-5 mb-4 trans-03-in-out">
          ...
          <h3 class="fw-200 pb-3 pt-3">Navs</h3>
            ...
            <div class="col-lg-12">
              <section class="widget shadow-01" id="widget-01">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Base nav</h3>
                    <p>The base <code class="highlighter-rouge">.nav</code> component is built with flexbox and provide a strong foundation for building all
            ...
            <div class="col-lg-12">
              <section class="widget shadow-01" id="widget-02">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Base nav centered</h3>
            ...
            <div class="col-lg-12">
              <section class="widget shadow-01" id="widget-03">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Base nav right-aligned</h3>
                    <p>Centered with <code class="highlighter-rouge">.justify-content-end</code>:</p>
                  </header>
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-04">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Nav vertical</h3>
                    <p>Stack your navigation by changing the flex item direction with the <code class="highlighter-rouge">.flex-column</code> utility. Need to
                      stack them on some viewports but not others? Use the responsive versions (e.g., <code class="highlighter-rouge">.flex-sm-column</code>).
                    </p>
                  </header>
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-05">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Nav vertical without ul</h3>
              ...
              <section class="widget shadow-01" id="widget-06">
                <div class="widget-block">
                  ...
                  <header>
                    ...
                    <p>Takes the basic nav from above and adds the <code class="highlighter-rouge">.nav-tabs</code> class to generate a tabbed interface. Use
                    ...
                    <div class="col-lg-12 widget-content py-2">
                      <div class="bd-example bd-example-tabs">
                        <ul class="nav nav-tabs" id="myTab1" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link" id="home-tab1" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">Home</a>
                          </li>
                          <li class="nav-item">
            ...
            <div class="col-lg-6">
              <section class="widget shadow-01" id="widget-07">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Pills</h3>
            ...
            <div class="col-lg-12">
              <section class="widget shadow-01" id="widget-08">
                <div class="widget-block">
                  ...
                  <header>
                    <h3 class="widget-title">Vertical Pills</h3>
                  </header>
