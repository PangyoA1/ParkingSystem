            ...
            <ul id="sidebarNav" class="nav nav-dark flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="Dashboard">
                        ...
                        <c:choose>
                         <c:when test="${fn:contains(URI,  '/dashboard')}">
                            <span class="d-none d-lg-inline" style="color: #d87a1a;font-weight: bold;">Dashboard</span>
                         </c:when>
                          <c:otherwise>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="MyDashboard">
                        ...
                        <c:choose>
                            <c:when test="${fn:contains(URI,  '/mydashboard')}">
                                <span class="d-none d-lg-inline" style="color: #d87a1a;font-weight: bold;">My Dashboard</span>
                            </c:when>
                            <c:otherwise>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="Community">
                        ...
                        <c:choose>
                            <c:when test="${fn:contains(URI,  '/community')}">
                                <span class="d-none d-lg-inline" style="color: #d87a1a;font-weight: bold;">Community</span>
                            </c:when>
                            <c:otherwise>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="Setting">
                        ...
                        <c:choose>
                            <c:when test="${fn:contains(URI,  '/setting')}">
                                <span class="d-none d-lg-inline" style="color: #d87a1a;font-weight: bold;">Setting</span>
                            </c:when>
                            <c:otherwise>
